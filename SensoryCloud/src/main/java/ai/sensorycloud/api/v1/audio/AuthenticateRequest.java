...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          case 0:
            ...
            break;
          case 10: {
            ai.sensorycloud.api.v1.audio.AuthenticateConfig.Builder subBuilder = null;
            if (streamingRequestCase_ == 1) {
              subBuilder = ((ai.sensorycloud.api.v1.audio.AuthenticateConfig) streamingRequest_).toBuilder();
            }
            streamingRequest_ =
                input.readMessage(ai.sensorycloud.api.v1.audio.AuthenticateConfig.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((ai.sensorycloud.api.v1.audio.AuthenticateConfig) streamingRequest_);
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      ai.sensorycloud.api.v1.audio.AuthenticateRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (ai.sensorycloud.api.v1.audio.AuthenticateRequest) e.getUnfinishedMessage();
