...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(ai.sensorycloud.api.v1.event.UsageEventListResponse result) {
      if (eventsBuilder_ == null) {
    ...
    private void buildPartial0(ai.sensorycloud.api.v1.event.UsageEventListResponse result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              ai.sensorycloud.api.v1.event.UsageEventResponse m =
                  input.readMessage(
                      ai.sensorycloud.api.v1.event.UsageEventResponse.parser(),
                      extensionRegistry);
              if (eventsBuilder_ == null) {
                ensureEventsIsMutable();
                events_.add(m);
