...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(ai.sensorycloud.api.v1.file.FileCatalogResponse result) {
      if (catalogBuilder_ == null) {
    ...
    private void buildPartial0(ai.sensorycloud.api.v1.file.FileCatalogResponse result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              ai.sensorycloud.api.v1.file.FileCatalog m =
                  input.readMessage(
                      ai.sensorycloud.api.v1.file.FileCatalog.parser(),
                      extensionRegistry);
              if (catalogBuilder_ == null) {
                ensureCatalogIsMutable();
                catalog_.add(m);
