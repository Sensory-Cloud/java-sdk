...
private static final long serialVersionUID = 0L;
  ...
  private long firstWordIndex_ = 0L;
  /**
   * <pre>
  ...
  private long lastWordIndex_ = 0L;
  /**
   * <pre>
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(ai.sensorycloud.api.v1.audio.TranscribeWordResponse result) {
      if (wordsBuilder_ == null) {
    ...
    private void buildPartial0(ai.sensorycloud.api.v1.audio.TranscribeWordResponse result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              ai.sensorycloud.api.v1.audio.TranscribeWord m =
                  input.readMessage(
                      ai.sensorycloud.api.v1.audio.TranscribeWord.parser(),
                      extensionRegistry);
              if (wordsBuilder_ == null) {
                ensureWordsIsMutable();
                words_.add(m);
